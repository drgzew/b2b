...
def generate_teachers(count: int = 20) -> List[Dict]:
    ...
    surnames = [
        ...
        "Семёнов", "Егоров", "Павлов", "Козлов", "Степанов", "Орлов", "Андреев",
        "Макаров", "Никитин", "Захаров", "Зайцев", "Соловьёв", "Борисов", "Григорьев",
    ]
    names = [
        "Александр", "Сергей", "Дмитрий", "Андрей", "Алексей", "Михаил", "Евгений",
        "Николай", "Игорь", "Олег", "Владимир", "Павел", "Артём", "Максим", "Иван",
    ]
    patronymics = [
        "Александрович", "Сергеевич", "Дмитриевич", "Андреевич", "Алексеевич",
        "Михайлович", "Евгеньевич", "Николаевич", "Игоревич", "Олегович",
        "Владимирович", "Павлович", "Артёмович", "Максимович", "Иванович",
    ]
    departments = [
        "Школа компьютерных наук", "Школа естественных наук",
        "Институт математики и компьютерных наук", "Институт социально-гуманитарных наук",
        "Институт государства и права", "Институт физической культуры",
        "Институт психологии и педагогики", "Институт наук о Земле",
    ]
    positions = ["Профессор", "Доцент", "Заведующий кафедрой", "Старший преподаватель", "Преподаватель"]
    ...
    for _ in range(count):
        ...
        email = f"{surname.lower()}.{name.lower()}.{random.randint(10, 99)}@utmn.ru"
